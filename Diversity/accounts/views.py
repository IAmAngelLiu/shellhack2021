...
def home(request):
	...
	female_points = max(int((0.5-total_female/total)*100)*100,0)
	race_points = max(int((0.5-total_race/total)*100)*100,0)
	college_points = max(int((0.5-total_college/total)*100)*100,0)
